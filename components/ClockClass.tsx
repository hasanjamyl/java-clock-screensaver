...
const ClockClass: React.FC<ClockClassProps> = ({ state }) => {
  const [pulse, setPulse] = useState({ s: false, m: false, h: false });
  ...
  useEffect(() => {
    const timer = setTimeout(() => setPulse({ s: false, m: false, h: false }), 400);
    return () => clearTimeout(timer);
  }, [pulse.s, pulse.m, pulse.h]);
  ...
  return (
    <div className="flex flex-col xl:flex-row gap-8 max-w-7xl w-full px-6 animate-in fade-in zoom-in duration-700">
      ...
      <div className="flex-grow bg-[#0d1117] border-2 border-[#30363d] rounded-2xl shadow-[0_30px_60px_rgba(0,0,0,0.6)] flex flex-col overflow-hidden">
        ...
        <div className="flex flex-grow font-mono">
          <div className="w-12 bg-[#0d1117] border-r border-[#30363d] pt-6 text-right pr-4 text-[10px] text-gray-600 select-none">
            {Array.from({ length: 26 }).map((_, i) => <div key={i} className="leading-6">{i + 1}</div>)}
          </div>

          <div className="p-8 flex-grow overflow-x-auto text-sm md:text-base lg:text-lg leading-6 text-gray-100">
            ...
            <br/>
            &nbsp;&nbsp;<Syntax type="comment">// Encapsulation: Private state</Syntax><br/>
            ...
            <br/>
            &nbsp;&nbsp;<Syntax type="comment">// Constructor</Syntax><br/>
            &nbsp;&nbsp;<Syntax type="keyword">public</Syntax> <Syntax type="type">SystemClock</Syntax>(<Syntax type="type">int</Syntax> <Syntax type="variable">h</Syntax>, <Syntax type="type">int</Syntax> <Syntax type="variable">m</Syntax>, <Syntax type="type">int</Syntax> <Syntax type="variable">s</Syntax>) {"{"}<br/>
            &nbsp;&nbsp;&nbsp;&nbsp;<Syntax type="keyword">this</Syntax>.<Syntax type="variable">hour</Syntax> <Syntax type="operator">=</Syntax> <Syntax type="variable">h</Syntax>;<br/>
            &nbsp;&nbsp;&nbsp;&nbsp;<Syntax type="keyword">this</Syntax>.<Syntax type="variable">minute</Syntax> <Syntax type="operator">=</Syntax> <Syntax type="variable">m</Syntax>;<br/>
            &nbsp;&nbsp;&nbsp;&nbsp;<Syntax type="keyword">this</Syntax>.<Syntax type="variable">second</Syntax> <Syntax type="operator">=</Syntax> <Syntax type="variable">s</Syntax>;<br/>
            &nbsp;&nbsp;{"}"}<br/>
            <br/>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<Syntax type="keyword">return</Syntax> <Syntax type="keyword">this</Syntax>.<Syntax type="variable">hour</Syntax> <Syntax type="operator">+</Syntax> <Syntax type="string">":"</Syntax> <Syntax type="operator">+</Syntax> <Syntax type="keyword">this</Syntax>.<Syntax type="variable">minute</Syntax> <Syntax type="operator">+</Syntax> <Syntax type="string">":"</Syntax> <Syntax type="operator">+</Syntax> <Syntax type="keyword">this</Syntax>.<Syntax type="variable">second</Syntax>;<br/>
            &nbsp;&nbsp;{"}"}<br/>
            {"}"}
          </div>
        </div>
      ...
      <div className="flex flex-col w-full xl:w-80 shrink-0 gap-6">
        <div className="bg-[#0d1117] border-2 border-[#30363d] rounded-2xl p-6 shadow-2xl">
          ...
          <div className="font-mono text-sm space-y-4">
            <div className="flex justify-between items-center bg-white/5 p-2 rounded">
              <span className="text-blue-300 text-xs">instance</span>
              <span className="text-gray-500 text-[10px]">@0x9F8B2</span>
            </div>
            <div className="space-y-3 pl-2">
              <div className="flex justify-between border-b border-white/5 pb-1">
                <span className="text-gray-400 text-xs">hour</span>
                <span className="text-white font-black">{pad(state.hour)}</span>
              </div>
              <div className="flex justify-between border-b border-white/5 pb-1">
                <span className="text-gray-400 text-xs">minute</span>
                <span className="text-white font-black">{pad(state.minute)}</span>
              </div>
              <div className="flex justify-between border-b border-white/5 pb-1">
                <span className="text-gray-400 text-xs">second</span>
                <span className={`text-white font-black transition-all ${pulse.s ? 'scale-125 text-purple-400' : ''}`}>{pad(state.second)}</span>
              </div>
              <div className="pt-2 flex flex-col gap-1">
                <span className="text-gray-500 text-[10px]">toString()</span>
                <span className="text-green-400 bg-green-400/10 border border-green-500/30 px-3 py-1 rounded text-center font-bold">
        ...
        <div className="bg-[#0d1117] border-2 border-[#30363d] rounded-2xl p-6 shadow-2xl flex-grow max-h-64 overflow-hidden relative">
          ...
          <div className="font-mono text-[10px] text-gray-500 space-y-2 opacity-60">
            ...
            <div className="text-gray-400 italic">[LOG] State synchronized with OS</div>
            <div className="animate-pulse text-blue-500 font-bold">_</div>
          </div>
          <div className="absolute inset-x-0 bottom-0 h-16 bg-gradient-to-t from-[#0d1117] to-transparent pointer-events-none"></div>
        </div>
      </div>
    </div>
  );
